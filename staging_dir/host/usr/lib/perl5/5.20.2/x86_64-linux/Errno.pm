...
"x86_64-linux-4.4.0-112-generic" or
	die "Errno architecture (x86_64-linux-4.4.0-112-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
